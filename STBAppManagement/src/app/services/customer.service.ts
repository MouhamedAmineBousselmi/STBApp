...
export class CustomerService {
    ...
    //-- METHODES
    GetListAdminCustomer(idAgence) {
        return this.authGet$(`http://localhost:44365/api/GetListCustomerAdmin/`+idAgence);
    }

    CustomerEdit(customer)
    {
        return this.authPost$(`http://localhost:44365/api/CustomerEdit/`,customer)
    }
    
    CustomerAdd(customer)
    {
        return this.authPost$(`http://localhost:44365/api/AddClient/`,customer)
    }

    DeleteCustomer(idClient)
    {
        return this.authGet$(`http://localhost:44365/api/DeleteCustomer/`+idClient);
    }
     //-- SECURING API DATA
     public authGet$(url) {
