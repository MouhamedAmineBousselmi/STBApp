...
export class EmployeService {
    ...
    //-- METHODES
    GetListAdminEmploye(IdAgence) {
        return this.authGet$(`http://localhost:44365/api/GetAdminEmployeData/`+IdAgence);
    }
    EmployeEdit(employeDTO)
    {
        return this.authPost$(`http://localhost:44365/api/EmployeEdit/`,employeDTO)
    }
    
    EmployeAdd(account)
    {
        return this.authPost$(`http://localhost:44365/api/AddEmploye/`,account)
    }

    DeleteEmploye(CodeEmploye)
    {
        return this.authGet$(`http://localhost:44365/api/DeleteEmploye/`+CodeEmploye);
    }
     //-- SECURING API DATA
     public authGet$(url) {
